...
using SubmissionService.DependencyExtensions;
using SubmissionService.Routes;
using System.Reflection;
using MediatR;
using SubmissionService.Components.Handlers;
using SubmissionService.Configurations;
...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddJwtBearer(builder.Configuration, false);
