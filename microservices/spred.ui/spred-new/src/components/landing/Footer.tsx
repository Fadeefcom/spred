    ...
    <footer className="bg-spred-black text-spred-white pt-16 md:pt-20 pb-10 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-mono text-sm uppercase mb-6">Quick Links</h4>
            <ul className="space-y-4">
              {[
                { name: 'Home', id: 'hero' },
                { name: 'How It Works', id: 'how-it-works' },
                { name: 'Try Demo', id: 'try-platform' },
                { name: 'How It Works', id: 'what-we-do' },
                { name: 'Get Access', id: 'demo-form' },
              ].map((link) => (
                <li key={link.id}>
                  <button
                    onClick={() => {
                    ...
                    className="text-spred-white/60 transition-colors animated-underline"
                  >
                    {link.name}
                  </button>
                </li>
