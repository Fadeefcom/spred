        ...
        <DialogPortal>
            ...
            <DialogPrimitive.Content
                ...
                className={cn(
                    ...
                    "max-h-[calc(90vh-2rem)] overflow-y-auto mx-4 w-[100vw]",
                    className
                )}
                {...props}
            >
                ...
                <DialogPrimitive.Close
                    className="absolute right-4 top-4 rounded-sm opacity-100 ring-offset-background transition-opacity
             hover:opacity-75 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2
             disabled:pointer-events-none border shadow-sm p-1 bg-transparent"
                >
                    <X className={cn(
                        "h-4 w-4",
